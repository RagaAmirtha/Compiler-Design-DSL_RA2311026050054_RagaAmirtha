...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_decl_stmt = 25,                 /* decl_stmt  */
...
static const char *const yytname[] =
{
  ...
  "NUMBER", "IDENTIFIER", "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "GT",
  "LT", "EQ", "SEMICOLON", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "$accept", "program", "stmt_list", "stmt", "decl_stmt", "assign_stmt",
  "print_stmt", "if_stmt", "condition", "expr", "term", "factor", YY_NULLPTR
};
...
{
      46,    -5,     4,     4,    11,    12,    46,   -19,   -19,   -19,
     -19,   -19,    21,   -19,   -19,     4,     9,    44,   -19,   -13,
      33,     4,   -19,   -19,     4,     6,     4,     4,   -19,     4,
       4,    46,     4,     4,     4,    18,    29,   -19,    44,    44,
     -19,   -19,     0,    20,    20,    20,   -19,   -19,   -19
};
...
{
       0,     0,     0,     0,     0,     0,     2,     4,     5,     6,
       7,     8,     0,    22,    23,     0,     0,    18,    21,     0,
       0,     0,     1,     3,     0,     0,     0,     0,    11,     0,
       0,     0,     0,     0,     0,     0,     0,    24,    16,    17,
      19,    20,     0,    13,    14,    15,    10,     9,    12
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -19,   -19,   -15,    -6,   -19,   -19,   -19,   -19,   -19,    -2,
     -18,    10
};
...
{
      23,    20,    12,     1,     2,     3,    31,     4,    38,    39,
      13,    14,    22,    25,    26,    27,    42,    26,    27,    35,
      48,    15,    36,    21,    37,    28,    26,    27,    26,    27,
      43,    44,    45,    24,    46,     0,    23,    26,    27,    40,
      41,    26,    27,     0,     0,    47,    32,    33,    34,     1,
       2,     3,     0,     4,    29,    30
};

static const yytype_int8 yycheck[] =
{
       6,     3,     7,     3,     4,     5,    19,     7,    26,    27,
       6,     7,     0,    15,     8,     9,    31,     8,     9,    21,
      20,    17,    24,    12,    18,    16,     8,     9,     8,     9,
      32,    33,    34,    12,    16,    -1,    42,     8,     9,    29,
      30,     8,     9,    -1,    -1,    16,    13,    14,    15,     3,
       4,     5,    -1,     7,    10,    11
};
...
{
       0,     3,     4,     5,     7,    22,    23,    24,    25,    26,
      27,    28,     7,     6,     7,    17,    30,    31,    32,    29,
      30,    12,     0,    24,    12,    30,     8,     9,    16,    10,
      11,    19,    13,    14,    15,    30,    30,    18,    31,    31,
      32,    32,    23,    30,    30,    30,    16,    16,    20
};
...
#line 1160 "parser.tab.c"
  ...
  case 9: /* decl_stmt: LET IDENTIFIER ASSIGN expr SEMICOLON  */
#line 50 "src/parser.y"
    { (yyval.node) = create_decl_node((yyvsp[-3].id), (yyvsp[-1].node)); }
#line 1166 "parser.tab.c"
    break;

  case 10: /* assign_stmt: IDENTIFIER ASSIGN expr SEMICOLON  */
#line 55 "src/parser.y"
    { (yyval.node) = create_assign_node((yyvsp[-3].id), (yyvsp[-1].node)); }
#line 1172 "parser.tab.c"
    break;

  case 11: /* print_stmt: PRINT expr SEMICOLON  */
#line 60 "src/parser.y"
    { (yyval.node) = create_print_node((yyvsp[-1].node)); }
#line 1178 "parser.tab.c"
    break;

  case 12: /* if_stmt: IF condition LBRACE stmt_list RBRACE  */
#line 65 "src/parser.y"
    { (yyval.node) = create_if_node((yyvsp[-3].node), (yyvsp[-1].node)); }
#line 1184 "parser.tab.c"
    break;

  case 13: /* condition: expr GT expr  */
#line 69 "src/parser.y"
                 { (yyval.node) = create_cond_node(">", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1190 "parser.tab.c"
    break;

  case 14: /* condition: expr LT expr  */
